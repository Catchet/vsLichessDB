use actix_web::{HttpResponse, post, web::{self, Json}};
use serde::{Deserialize, Serialize};
use shakmaty::fen::Fen;

use crate::{ChessCache, ChessPosStats, errors::ApiError, modules::chess::util::select_random_move, query_lichess};
...
#[post("next-move")]
pub async fn calculate_next_move(client: web::Data<reqwest::Client>, cache: web::Data<ChessCache>, input: Json<CalcNextMoveInput>) -> Result<HttpResponse, ApiError> {
